...
@section('capital-title', 'Create circle')
@section('home-title', 'Circle')
@section('small-title', 'circles')
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Create circle</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form id="create-form">
...
@section('scripts')
    <script>
      function store () {
        // alert('Sure');
        axios.post('/masged/manager/circle', {
